                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ open: false }" @click.away="open = false">
                            <button type="button" @click="open = !open" @class([
                                'inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500',
                                'text-blue-600 bg-blue-50' => request()->routeIs('settings.*'),
                            ])>
